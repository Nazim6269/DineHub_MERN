                ...
                <div className="flex flex-col gap-4">
                    {items.length ? (
                        items.map((item) => (
                            <div
                                key={item._id}
                                className="group flex gap-4 bg-app-bg p-4 rounded-md border border-border-thin hover:border-brand-primary/20 hover:shadow-xl hover:shadow-text-main/5 transition-all duration-300"
                            >
