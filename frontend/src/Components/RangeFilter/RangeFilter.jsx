    ...
    return (
        <div className="w-full">
            ...
            <div className="flex justify-between mt-8 gap-4">
                <div className="flex-1 bg-app-bg border border-border-thin rounded-md text-center py-3 text-sm font-black text-text-main shadow-sm uppercase tracking-tighter">
                    Tk {values[0]}
                </div>
