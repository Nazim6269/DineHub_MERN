      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="relative rounded-[2.5rem] overflow-hidden border border-border-thin bg-card-bg shadow-xl group">
              <img
                src={img}
                alt={name}
          ...
          <div className="lg:col-span-5 flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {options.map((opt, idx) => (
                    <button
                      ...
                      className={`p-6 rounded-3xl border-2 text-left transition-all relative overflow-hidden group ${selectedOption === idx
            ...
            <div className="flex flex-col gap-4">
              <button
                ...
                className="w-full py-5 bg-brand-primary text-text-on-brand font-black text-lg rounded-3xl shadow-lg shadow-brand-primary/20 hover:scale-105 transition-all flex items-center justify-center gap-3 active:scale-95"
              >
                <ShoppingBag size={24} />
              ...
              <Link
                to="/cart"
                className="w-full py-5 text-center bg-text-main text-text-on-brand font-black text-lg rounded-3xl hover:opacity-90 transition-all flex items-center justify-center gap-3 active:scale-95 shadow-lg shadow-text-main/10"
              >
                GO TO CHECKOUT
              </Link>
            </div>
        ...
        <div className="mt-24 pt-24 border-t border-border-thin">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              <div className="bg-card-bg border border-border-thin rounded-[3rem] p-10">
            ...
            <div className="lg:col-span-4 space-y-8">
              <div className="sticky top-24 space-y-8">
                <div className="bg-brand-primary/5 border border-brand-primary/10 rounded-[3rem] p-8">
                  <h3 className="text-xl font-black mb-6 text-brand-primary uppercase tracking-wider">Recommended</h3>
                  <RelatedItem />
                </div>

                <div className="bg-card-bg border border-border-thin rounded-[3rem] p-8">
