                                    ...
                                    <div className="absolute right-0 mt-3 w-64 origin-top-right rounded-[2rem] border border-border-thin bg-app-bg p-3 shadow-2xl ring-1 ring-black/5">
                                        ...
                                        <div className="space-y-1">
                                            {profile.role === "admin" && (
                                                <Link
                                                    to="/admin/dashboard"
                                                    className="flex items-center gap-3 rounded-md px-4 py-3 text-sm font-bold text-text-sub transition-all hover:bg-surface-bg hover:text-brand-primary"
                                            ...
                                            <button
                                                ...
                                                className="flex w-full items-center gap-3 rounded-md px-4 py-3 text-sm font-bold text-status-error transition-all hover:bg-red-50"
                                            >
                                                <LogOut size={18} />
                                                Secure Logout
                                            </button>
                            ...
                            <div className="flex flex-col gap-2">
                                {navLinks.map((link) => (
                                    <Link
                                        key={link.name}
                                        to={link.path}
                                        className="px-4 py-3 text-sm font-black uppercase tracking-widest text-text-sub hover:text-brand-primary hover:bg-surface-bg rounded-md transition-all"
