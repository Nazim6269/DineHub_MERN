        ...
        <div className="flex flex-col gap-4">
          {items.length ? (
            items.map((item) => (
              <div
                key={item._id}
                className="group flex gap-4 bg-app-bg p-4 rounded-2xl border border-border-thin hover:border-brand-primary/20 transition-all duration-300 shadow-sm hover:shadow-lg hover:shadow-text-main/5"
              >
