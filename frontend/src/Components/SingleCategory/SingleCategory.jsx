      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="w-full lg:w-1/4 space-y-6">
            <div className="bg-card-bg border border-border-thin rounded-[2rem] p-8 shadow-sm">
          ...
          <main className="w-full lg:w-3/4 space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center justify-between bg-app-bg border border-border-thin rounded-[2.5rem] p-8 shadow-xl shadow-text-main/5">
              <div>
              ...
              <div className="flex flex-wrap items-center gap-6">
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="rounded-xl px-4 py-2 text-xs font-bold bg-card-bg border border-border-thin text-text-main focus:border-brand-primary outline-none transition appearance-none cursor-pointer"
                  >
            ...
            {filteredData.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
                {filteredData.map((item) => (
                  <div
                    key={item._id}
                    className="group bg-card-bg border border-border-thin rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-brand-primary/30 hover:shadow-xl hover:shadow-text-main/5"
                  >
